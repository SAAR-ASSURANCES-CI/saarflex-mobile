...
import '../screens/beneficiaires/simple_beneficiaire_form.dart';
...
class BeneficiairesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<BeneficiaireProvider>(
  ...
  Widget _buildHeader(BuildContext context, BeneficiaireProvider provider) {
    return Container(
