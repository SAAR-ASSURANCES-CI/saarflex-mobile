...
class _BeneficiairesCollectionWidgetState
  ...
  bool _areBeneficiairesValid(SimulationProvider provider) {
  ...
  Widget _buildBeneficiairesList(SimulationProvider provider) {
    return Column(
  ...
  Widget _buildAddButton(SimulationProvider provider) {
    return SizedBox(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              Provider.of<SimulationProvider>(
                context,
                listen: false,
