...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildInfoRow(String label, String value, {bool isExpirationDate = false}) {
    ...
    // Si c'est une date d'expiration, vérifier si elle est proche ou dépassée
    if (isExpirationDate && value != "Non renseignée") {
      try {
        ...
        // En cas d'erreur de parsing, couleur normale
          ...
          Expanded(
            ...
            child: Row(
              children: [
                ...
                // Icône d'avertissement pour les dates d'expiration
